...
DATABASES = {
    'default': {
        ...
        'NAME': 'fileserver',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'nsfocus',                  # Not used with sqlite3.
        'HOST': '10.7.201.130',                      # Set to empty string for localhost. Not used with sqlite3.
